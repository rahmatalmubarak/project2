...
<div class="container-fluid col-6">
    ...
    <div class="invoice p-3 mb-3">
        ...
        <div class="row no-print">
            <div class="col-12">
                <a href="" onclick="window.print()" target="_blank" class="btn btn-default"><i class="fas fa-print"></i>
                    Print</a>

                <a href="/detail/cetak/{{$item->id}}" type="button" class="btn btn-primary float-right" style="margin-right: 5px;">
